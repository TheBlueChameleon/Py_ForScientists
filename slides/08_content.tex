...
\column{.6\linewidth}
\begin{center}
\includegraphics[width=\linewidth]{./gfx/08-xkcd-fourier}\\
\end{center}
%
\column{.2\linewidth}
\small
...
\item Returns array
	...
	\item \inPy{result[k]} for $\texttt{k} \in [\lfloor \sfrac{N}{2} \rfloor + 1, ... N]$: complex amplitude for $\omega_k = \dfrac{2\pi (k-N)}{\max(t_k)}$
...
\begin{columns}
\column{.6\linewidth}
\includegraphics[width=\linewidth]{./gfx/08-FFT-1D}
%
\column{.35\linewidth}
\begin{itemize}
...
\begin{columns}[T]
\column{.75\linewidth}
\includegraphics[width=\linewidth]{./gfx/08-FFT-2D}
%
\column{.2\linewidth}
\begin{itemize}
...
\vspace{-43pt}
\begin{center}
	\includegraphics[width=.74\linewidth]{./gfx/08-xkcd-curveFitting}
\end{center}
\end{columns}
%
\end{frame}
...
\begin{columns}
\column{.45\linewidth}
\includegraphics[width=\linewidth]{./gfx/08-simple-fit}
%
\column{.5\linewidth}
...
\begin{columns}
\column{.45\linewidth}
\includegraphics[width=\linewidth]{./gfx/08-curvefit-fail}
%
\column{.5\linewidth}
...
\begin{columns}
\column{.5\linewidth}
\includegraphics[width=.8\linewidth]{./gfx/08-runge-spikes}
...
\column{.6\linewidth}
\begin{center}
\includegraphics[width=\linewidth]{./gfx/08-xkcd-metamaterials}\\
\end{center}
%
\column{.3\linewidth}
\small
...
\begin{columns}
\column{.7\linewidth}
\includegraphics[width=\linewidth]{./gfx/08-filters}
%
\column{.3\linewidth}
...
\column{.6\linewidth}
\begin{center}
\includegraphics[width=\linewidth]{./gfx/08-xkcd-everything}\\
\end{center}
%
\column{.3\linewidth}
\small
